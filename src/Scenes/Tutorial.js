class Tutorial extends Phaser.Scene {
    ...
    create() {
        ...
        my.sprite.player = this.physics.add.sprite(500, 700, "platformer_characters", "tile_0000.png");
        my.sprite.player.setCollideWorldBounds(true);
        my.sprite.token = this.add.sprite(343, 675, "token1");
        my.sprite.token.visible = false;
        my.sprite.end = this.add.sprite(343, 675, "end1");
        my.sprite.end.visible = false;
        
        my.sprite.npc = this.add.sprite(320, 700, "platformer_characters", "tile_0025.png");
        ...
        my.text.help = this.add.text(my.sprite.player.x - 200, 620, "Use arrow keys to move\nLeft is left, Right is right\nUp is to jump", {
        ...
        my.text.spaceNext = this.add.text(my.sprite.player.x - 200, 720, "[Space] to go to next rule // [X] to skip the tutorial", {
    ...
    update() {
        ...
        if (Phaser.Input.Keyboard.JustDown(this.next)) {
            ...
            if (this.index == 0){
                my.text.help.setText("See the number above your head?\nThat's you Energy Bar\nYou loose if it hits 0");
                this.index++;
            } else if (this.index == 1){
                my.text.help.setText("Resting & Tokens restore energy\nToken this level look like this\n >>      <<");
                my.sprite.token.visible = true;
                this.index++;
                console.log(this.index);
            } else if (this.index == 2){
                my.sprite.token.visible = false;
                my.text.help.setText("There seems to be acid below you\nCareful not to fall into it!");
                this.index++;
                console.log(this.index);
            } else if (this.index == 3){
                my.text.help.setText("Your goal: get to the end alive\nThe end of this level looks like this\n >>      <<");
